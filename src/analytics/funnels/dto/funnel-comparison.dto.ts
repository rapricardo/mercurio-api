...
export interface ABTestResults {
  ...
  business_impact: {
    ...
    implementation_recommendation: 'implement_winner' | 'continue_testing' | 'inconclusive' | 'no_significant_difference';
  };
...
export interface ComparisonInsight {
  insight_type: 'performance_gap' | 'statistical_significance' | 'trend_divergence' | 'segment_opportunity' | 'timing_optimization';
  title: string;
  description: string;
...
export interface OptimizationRecommendation {
  ...
  category: 'funnel_design' | 'user_experience' | 'traffic_acquisition' | 'conversion_optimization' | 'testing_strategy';
