...
export interface TouchpointAttribution {
  ...
  touchpoint_type: 'organic_search' | 'paid_search' | 'direct' | 'referral' | 'social' | 'email' | 'display' | 'other';
  touchpoint_details: {
    utm_source?: string;
    utm_medium?: string;
    utm_campaign?: string;
...
export interface AttributionInsight {
  insight_type: 'high_performer' | 'underperformer' | 'trend_change' | 'attribution_shift' | 'optimization_opportunity';
  title: string;
  description: string;
