...
export class PrismaRLSService {
   ...
   */
  async withRLSContext<T>(context: RLSContext | null, operation: () => Promise<T>): Promise<T> {
    if (!context) {
  ...
  createContextualClient(context: RLSContext | null) {
    return {
      ...
      tenant: {
        findMany: (args?: any) =>
          this.withRLSContext(context, () => this.prisma.tenant.findMany(args)),
        findUnique: (args: any) =>
          this.withRLSContext(context, () => this.prisma.tenant.findUnique(args)),
        findFirst: (args?: any) =>
          this.withRLSContext(context, () => this.prisma.tenant.findFirst(args)),
      ...
      workspace: {
        findMany: (args?: any) =>
          this.withRLSContext(context, () => this.prisma.workspace.findMany(args)),
        findUnique: (args: any) =>
          this.withRLSContext(context, () => this.prisma.workspace.findUnique(args)),
        findFirst: (args?: any) =>
          this.withRLSContext(context, () => this.prisma.workspace.findFirst(args)),
        create: (args: any) =>
          this.withRLSContext(context, () => this.prisma.workspace.create(args)),
        update: (args: any) =>
          this.withRLSContext(context, () => this.prisma.workspace.update(args)),
        delete: (args: any) =>
          this.withRLSContext(context, () => this.prisma.workspace.delete(args)),
        count: (args?: any) =>
          this.withRLSContext(context, () => this.prisma.workspace.count(args)),
      },
      event: {
        findMany: (args?: any) =>
          this.withRLSContext(context, () => this.prisma.event.findMany(args)),
        findUnique: (args: any) =>
          this.withRLSContext(context, () => this.prisma.event.findUnique(args)),
        findFirst: (args?: any) =>
          this.withRLSContext(context, () => this.prisma.event.findFirst(args)),
        ...
        createMany: (args: any) =>
          this.withRLSContext(context, () => this.prisma.event.createMany(args)),
      },
      visitor: {
        findMany: (args?: any) =>
          this.withRLSContext(context, () => this.prisma.visitor.findMany(args)),
        findUnique: (args: any) =>
          this.withRLSContext(context, () => this.prisma.visitor.findUnique(args)),
        findFirst: (args?: any) =>
          this.withRLSContext(context, () => this.prisma.visitor.findFirst(args)),
      ...
      lead: {
        findMany: (args?: any) =>
          this.withRLSContext(context, () => this.prisma.lead.findMany(args)),
        findUnique: (args: any) =>
          this.withRLSContext(context, () => this.prisma.lead.findUnique(args)),
        findFirst: (args?: any) =>
          this.withRLSContext(context, () => this.prisma.lead.findFirst(args)),
      ...
      session: {
        findMany: (args?: any) =>
          this.withRLSContext(context, () => this.prisma.session.findMany(args)),
        findUnique: (args: any) =>
          this.withRLSContext(context, () => this.prisma.session.findUnique(args)),
        findFirst: (args?: any) =>
          this.withRLSContext(context, () => this.prisma.session.findFirst(args)),
      ...
      userProfile: {
        findMany: (args?: any) =>
          this.withRLSContext(context, () => this.prisma.userProfile.findMany(args)),
        findUnique: (args: any) =>
          this.withRLSContext(context, () => this.prisma.userProfile.findUnique(args)),
        findFirst: (args?: any) =>
          this.withRLSContext(context, () => this.prisma.userProfile.findFirst(args)),
        create: (args: any) =>
          this.withRLSContext(context, () => this.prisma.userProfile.create(args)),
        update: (args: any) =>
          this.withRLSContext(context, () => this.prisma.userProfile.update(args)),
        upsert: (args: any) =>
          this.withRLSContext(context, () => this.prisma.userProfile.upsert(args)),
        count: (args?: any) =>
          this.withRLSContext(context, () => this.prisma.userProfile.count(args)),
      },
      userWorkspaceAccess: {
        findMany: (args?: any) =>
          this.withRLSContext(context, () => this.prisma.userWorkspaceAccess.findMany(args)),
        findUnique: (args: any) =>
          this.withRLSContext(context, () => this.prisma.userWorkspaceAccess.findUnique(args)),
        findFirst: (args?: any) =>
          this.withRLSContext(context, () => this.prisma.userWorkspaceAccess.findFirst(args)),
        create: (args: any) =>
          this.withRLSContext(context, () => this.prisma.userWorkspaceAccess.create(args)),
        update: (args: any) =>
          this.withRLSContext(context, () => this.prisma.userWorkspaceAccess.update(args)),
        count: (args?: any) =>
          this.withRLSContext(context, () => this.prisma.userWorkspaceAccess.count(args)),
      },
